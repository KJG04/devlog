  ...
  return (
    <section className="m-auto max-w-screen-lg px-4">
      ...
      >
        ...
        <p>끝까지 가보자는 마음으로 정보기술 분야에 참여하게 되었습니다.</p>
        <p>
          아쉽게도 상을 타진 못했지만 많은 사람과 경쟁하며 배운 Java와 MySQL의
          지식이 개발자로서의 좋은 경험이 되었다고 생각합니다.
        </p>
      </Activity>
      <div className="mt-16" />
      <Activity
      ...
      >
        ...
        <p>거의 모르는 사람과 프로젝트를 진행하는 경험이 특별하였습니다.</p>
        <p>
