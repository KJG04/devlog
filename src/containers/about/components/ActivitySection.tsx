  ...
  return (
    <section className="m-auto max-w-screen-lg px-4">
      ...
      <Activity
        ...
        date="2021. 04."
      >
        학교에서 지방기능경기대회에 참여할 수 있는 기회를 가지게 되어서 정보기술
        분야에 참여하였습니다. <br />
        Java와 MySQL을 사용하여 주어진 응용 프로그램을 개발하는 것이
        목표였습니다. 대회 준비를 하며 Java와 MySQL을 공부한것이 개발자로서 많은
        도움이 되었다고 생각합니다. <br />
      ...
      <Activity
        ...
        date="2021. 10."
      >
        지방기능경기대회에서 메달권에 들어가서 전국기능경기대회에 참여할 자격을
        얻게 되었습니다. <br /> 끝까지 가보자는 마음으로 정보기술 분야에
        참여하게 되었습니다. <br /> 아쉽게도 상을 타진 못했지만 많은 사람과
        경쟁하며 배운 Java와 MySQL의 지식이 개발자로서의 좋은 경험이 되었다고
        생각합니다.
      </Activity>
      <div className="mt-16" />
      <Activity
