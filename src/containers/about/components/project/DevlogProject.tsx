        ...
        <div>
          ...
          <motion.div {...slideAnimationProps}>
            <div className="mt-2">
              ...
              <br />
              <p>
                블로그에서 중요한 것은 빠른 로딩, 가독성, 접근성, 검색엔진
                최적화, 반응형 UI로 정하고 개발하였습니다.
              </p>
              <p>
                Lighthouse를 사용해 웹 성능 측정을 하여 점수가 낮게 나오는
                부분을 개선했습니다. SSR을 사용해 FCP를 개선하고, metadata를
                추가해 SEO 작업을 하였습니다. 이미지 최적화, 폰트 최적화를 통해
                에셋을 줄여 로딩 시간을 개선하였습니다.
              </p>
              <p>
