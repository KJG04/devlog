      ...
      <div className="flex flex-col gap-4 sm:flex-row">
        ...
        <div>
          ...
          <motion.div {...slideAnimationProps}>
            <div className="mt-2">
              <p>프론트엔드 2명, 백엔드 1명 구성으로 진행한 프로젝트입니다.</p>
              <p>
                학교장 인증제중 하나인 ‘프로젝트 보고서 작성’을 위해 프로젝트를
                진행한 후 보고서를 작성하여 선생님께 제출해야 하는데 모든 과정이
                오프라인으로 진행 되어서 불편하였습니다. 이런 불편함을 고치기
                위해 온라인 상에서 보고서 작성의 모든 과정을 진행 할 수 있도록
                서비스를 기획하였습니다.
              </p>
              <p>
                React Query를 사용하여 캐싱과 개발 툴로 개발 경험과 유저 경험을
                개선하였고, custom hook을 작성하여 중복되는 코드를
                최소화했습니다. 노션과 같은 사용자 경험을 위해 비슷한 마크다운
                입력과 이미지 삽입 기능도 구현하였습니다.
              </p>
              <p>
                <Link
                  href="https://fate-course-159.notion.site/Teamit-578ad0c443fa409e816e3fa836f118eb"
