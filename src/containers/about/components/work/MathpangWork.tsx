      ...
      <div className="flex flex-col gap-4 sm:flex-row">
        ...
        <div>
          ...
          <motion.div {...slideAnimationProps}>
            ...
            <div className="mt-2">
              <p>
                ...
                리스크와 많은 개발 시간이 필요했고, QA 시간도 필요했습니다.
                빠르게 실행하는 현재 상황에 맞지 않는 방법이여서 번번히 뒤로
                미루어졌습니다.
              </p>
              <br />
              <p>
              ...
              <br />
              <p>
                <b>SSR을 적용해서 First Contentful Paint를 개선</b>
                하여 유저 경험을 개선하였고, 기존보다{' '}
                <b>빠른 로컬 실행 속도, 빌드 속도로 개발 경험이 개선</b>
                되었습니다.
              </p>
              <br />
          ...
          <motion.div {...slideAnimationProps}>
            ...
            <p>
              React Native 사용 경험이 팀 내 저 밖에 없어서 제가 앱 개발을
              리딩하였습니다. 웹뷰와 앱 사이의 로그인 세션 관리와 인앱 결제를
              개발하였습니다.
            </p>
          </motion.div>
          <div className="mt-4" />
          <motion.div {...slideAnimationProps}>
            ...
            <div className="mt-2">
              <p>
                ...
                <b>11MB에서 0.4MB</b>로 줄이고 로딩에 걸리는 시간을{' '}
                <b>1.1분에서 6초로 약 90% 속도 개선</b>을 하였습니다.
              </p>
              <p>
          ...
          <motion.div {...slideAnimationProps}>
            ...
            <div className="mt-2">
              <p>
                ...
                React Query 도입을 리딩하여 팀원 분들이 빠르게 사용하실 수
                있도록 기존 apollo client의 개발 경험과 비슷하도록 커스텀 훅을
                작성하여 도입하였습니다.
              </p>
              <p>
          ...
          <motion.div {...slideAnimationProps}>
            ...
            <div className="mt-2">
              <p>
                앱 전환 전 개발적 검증과 사전 작업을 진행하고 리딩하였습니다.
                기존 웹 서비스가 앱의 웹뷰 환경에서 잘 실행이 되는지, 어떤
                방식으로 개발을 하면 좋을지 실험하였습니다. 웹 서비스가 웹뷰
                환경에서 잘 동작되었고, 빠른 배포를 위해 모든 페이지를 웹뷰로
                제작하기로 결정했습니다. 실험 중 웹과 앱 사이의 통신할 때 작성된
                코드가 가독성이 좋지 않고 정해진 규칙이 없어서 휴먼 에러가
                발생할 수 있는 문제를 타입 지정과 Promise 사용을 통해
                해결하였습니다. 통신하는 코드를 훅으로 작성해 재사용성을
                높였습니다.
              </p>
              <p>
          ...
          <motion.div {...slideAnimationProps}>
            ...
            <div className="mt-2">
              <p>
                ...
                힘든 문제가 있었습니다. 이를 해결하기 위해 Pn룰 도입을
                제안드렸고, 적용되어서 코드 리뷰 시간을 줄일 수 있었습니다.
              </p>
            </div>
          </motion.div>
        </div>
